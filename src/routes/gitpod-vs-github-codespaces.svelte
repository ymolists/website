...
<script>
  ...
  import ComparisonTable from "$lib/components/tables/comparison-table.svelte";

  import { codeSpacesComparisonTable } from "$lib/contents/codespaces";
</script>
...
<ComparisonTable tableData={codeSpacesComparisonTable} />
<p>
  <small
