...
- After [Gitpod launched OpenVSCode Server](https://www.gitpod.io/blog/openvscode-server-launch) in September, Microsoft now open-sourced the server code powering VS Code remote development and GitHub Codespaces
...
When we launched our [history of the last four years of Cloud IDEs](https://www.gitpod.io/blog/cloud-ide-history) on Oct 20, we spoke about the road ahead:
...
- enable the marketplace using [Open VSX](https://www.gitpod.io/blog/open-vsx)
