...
<script>
  ...
  import Header from "$lib/components/gitpod-vs-github-codespaces/header.svelte";
...
<FeatureBox
  feature={{
    ...
    image: {
      src: "/images/gitpod-vs-github-codespaces/spaces-1.svg",
...
<FeatureBox
  feature={{
    ...
    image: {
      src: "/images/gitpod-vs-github-codespaces/spaces-2.svg",
...
<Section>
  <div class="featureTable">
    ...
    <section
      class="p-xx-small sm:py-small sm:px-x-small md:p-medium rounded-2xl bg-off-white alive text-center"
    >
    ...
    <section
      class="p-xx-small sm:py-small sm:px-x-small md:p-medium rounded-2xl bg-off-white text-center shadow-normal"
    >
