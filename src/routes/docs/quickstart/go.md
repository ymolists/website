...
Learn how to set-up and understand the benefits of Gitpod **in less than 5 min** with our [Go](https://github.com/gitpod-io/golang-cli-starter) example.
...
- Create a new repository based on the [Go template](https://github.com/gitpod-io/golang-cli-starter/generate).
