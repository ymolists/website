...
- You can now configure the service type of the proxy service in the installation UI - you do not need to upload a `.yaml` file as a [support patch](../docs/self-hosted/latest/support-patches) anymore to configure this. However, having it in the support patch will still work until December.
