...
export const programBenefits: ProgramBenefit[] = [
  ...
  },
  {
    ...
    title: "Double up",
    text:
      'If your startup is affiliated with <a href="/for/startups/organisations">an approved VC, incubator or accelerator</a> we will extend the program from 1 year to 2 years.',
  },
  {
    icon: {
